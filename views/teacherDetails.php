<?php require_once "header.php"?>
    <ol class="breadcrumb">
        ...
        <li class="active">Детайли за Учител</li>
    </ol>
                ...
                <form class="form" method="post" action="<?php  echo  site_url("homeController/postTeacherClasses?id=").$data['id']; ?>">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4 <?php echo (form_error('first_name'))?'has-error':''; ?>">
                            ...
                            <input name="first_name" type="text" class="form-control formfield" id="first_name" value="<?php echo $data["first_name"];?>" placeholder="Име" readonly>
                        ...
                        <div class="form-group col-md-4 <?php echo (form_error('middle_name'))?'has-error':''; ?>">
                            ...
                            <input name="middle_name" type="text" class="form-control formfield" id="middle_name" value="<?php echo $data['middle_name']; ?>" placeholder="Презиме" readonly>
                        ...
                        <div class="form-group col-md-4 <?php echo (form_error("last_name"))?'has-error':''; ?>">
                            ...
                            <input  name="last_name" type="text" class="form-control formfield" id="last_name"  value="<?php echo $data['last_name']; ?>" placeholder="Фамилия" readonly>
                    ...
                    <div class="row">
                        ...
                        <input name="civilnum" type="text" class="form-control formfield" id="civilnum" value="<?php echo $data['civilnum']; ?>" placeholder="ЕГН" readonly>
                        </span>
                        ...
                        <div class="form-group col-md-4 <?php echo (form_error('address'))?'has-error':''; ?>">
                            ...
                            <input name="address" type="text" class="form-control formfield" id="address" value="<?php echo $data['address']; ?>" placeholder="Адрес" readonly>
                        ...
                        <div class="form-group col-md-4 <?php echo (form_error('tel'))?'has-error':''; ?>">
                            ...
                            <input name="tel" type="text" class="form-control formfield" id="tel" value="<?php echo $data['tel']; ?>" placeholder="Тел." readonly>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4 <?php echo (form_error('email'))?'has-error':''; ?>">
                            ...
                            <input name="email" type="email" class="form-control formfield" id="email" value="<?php echo $data['email']; ?>" placeholder="Имейл" readonly>
                        ...
                        <div class="form-group col-md-4 <?php echo (form_error('date_of_birth'))?'has-error':''; ?>">
                            ...
                            <input name="date_of_birth" type="date" class="form-control formfield" id="date_of_birth" value="<?php echo $data['date_of_birth']; ?>" placeholder="Дата на раждане" readonly>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4 <?php echo (form_error('subject'))?'has-error':''; ?>">
                            ...
                            <input name="subject" type="text" class="form-control formfield" id="subject" value="<?php echo $data['subject']; ?>" placeholder="Учебен предмет" readonly>
                        ...
                        <div class="form-group col-md-4 <?php echo (form_error('subject2'))?'has-error':''; ?>">
                            ...
                            <input name="subject2" type="text" class="form-control formfield" id="subject2" value="<?php echo $data['subject2']; ?>" placeholder="Втори предмет" readonly>
                                    ...
                                    <div class="rows col-md-12" >
                                       ...
                                       <hr>
                                        ...
                                        <ul class="nav nav-tabs nav-justified"><?php $count=0; if(!empty($data['subjects'][0])) foreach($data['subjects'] as $key=> $subject) {?>
                                                ...
                                                <li><a readonly style="font-size: 20px" name="subject[]" value="<?php echo $count; ?>"<?php echo (isset($_POST['subject'])&&  $_POST['subject']==$key)?'selected':''; ?>><label for="" class="labels" style="float:left"><?php echo($count==0)?'Първи Учебен Предмет':'Втори Учебен Предмет'; ?></label><?php echo $subject; $count++;?></a></li>
                                            <?php } else{?>
                                                <li><a readonly name="subject[]" value="0" selected ><?php echo $data['subject']; $index1='first_subj_deg';  $index2='first_subj_class'; $number=count($data['first_subj_deg']);?></a></li>
                                                <li><a readonly name="subject[]" value="1" ><?php echo isset($data['subject2'])?$data['subject2']:''; $index1='second_subj_deg';  $index2='second_subj_class'; $number=count($data['second_subj_deg'])?></a></li>
                    ...
                    <div class="row">
                        <div class="form-group col-md-5">
                            <table class="table classes" style="margin-left:50px">
                                <?php  $number=count($data['first_subj_deg']);
                                $i=8; for($i=8;$i<13;$i++){?>
                                    <tr>
                                        <?php $alpha="ABVGDE";  for($j=0;$j<6;$j++){ ?>

                                            <td><label for="class" class="h4label"><?php echo $i.$alpha[$j]; ?></label><input readonly type="checkbox" name="class[]" id="class[]" value="<?php echo set_checkbox('class[]', $i." ".$alpha[$j]); ?>"
                            ...
                            <table class="table classes" style="margin-left:130px">
                             ...
                             $i=8; for($i=8;$i<13;$i++){?>
                                ...
                                <td><label for="class" class="h4label"><?php echo $i.$alpha[$j]; ?></label><input readonly  type="checkbox" name="class[]" id="class[]" value="<?php echo set_checkbox('class[]', $i." ".$alpha[$j]); ?>"
                                    ...
                                    <?php if(!empty($data['subjects'][0]))foreach($data['second_subj_deg'] as $key => $degree) echo ($degree." ".$data['second_subj_class'][$key]== $i." ".$alpha[$j])?'checked':''; ?> style="margin-left: 10px"/></td>
                                     <?php  } ?>
                                </tr>
                             <?php  } ?>
                            </table>
