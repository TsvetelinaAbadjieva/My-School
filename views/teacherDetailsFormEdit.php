...
<form class="form" method="post" action="<?php echo site_url("homeController/editTeacher?id={$data['id']}"); ?>">
    ...
    <div class="row">
        <nav class="list-group-item col-md-12">
            <div class="container-fluid teacherpanel">
                ...
                $i=8; for($i=8;$i<13;$i++){?>
                    <tr>
                        <?php $alpha="ABVGDE";  for($j=0;$j<6;$j++){ ?>
                            ...
                            <td><label for="first_class" class="h4label"><?php echo $i.$alpha[$j]; ?></label><input  type="checkbox" name="first_class[]" id="first_class[]" value="<?php echo set_checkbox('first_class[]', $i." ".$alpha[$j]); ?>"
                                    <?php if(isset($_POST['first_class'])){
                                        echo set_checkbox('first_class[]', $i." ".$alpha[$j]);
                                        $classes1[]=$i." ".$alpha[$j];
                                    } ?>
                    ...
                    $i=8; for($i=8;$i<13;$i++){?>
                        <tr>
                            <?php $alpha="ABVGDE";  for($j=0;$j<6;$j++){ ?>
                                ...
                                <td><label for="second_class" class="h4label"><?php echo $i.$alpha[$j]; ?></label><input  type="checkbox" name="second_class[]" id="second_class[]" value="<?php echo set_checkbox('second_class[]', $i." ".$alpha[$j]); ?>"
